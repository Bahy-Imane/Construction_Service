...
public class ProjectDaoImp implements ProjectDao {
    ...
    public void addProject(Project project) throws SQLException {
        try (Connection connection = Db_Connection.getConnection();
            ...
            statement.setString(7, project.getpImg());
    ...
    public List<Project> selectAllProjects() throws SQLException {
        ...
        try (Connection connection = Db_Connection.getConnection();
            ...
            while (rs.next()) {
                ...
                allProjects.add(new Project(pId, pName, pDescription, pStartdate, pEndDate, budget,pImg));
            }
        }
        return allProjects;
    }
        ...
        try (Connection connection = Db_Connection.getConnection();
            ...
            try (ResultSet rs = statement.executeQuery()) {
                if (rs.next()) {
                    ...
                    double budget = rs.getDouble("budget");
                    String pImg = rs.getString("p_img");
                    project = new Project(pId, pName, pDescription, pStartdate, pEndDate, budget,pImg);
                }
            }
        }
        return project;
