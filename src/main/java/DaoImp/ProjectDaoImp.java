...
public class ProjectDaoImp implements ProjectDao {
    ...
    private String INSERT_PROJECT_SQL="INSERT INTO project (p_id, p_name, p_description, p_start_date, p_end_date, budget) VALUES (?, ?, ?, ?, ?, ?);";
    private String UPDATE_PROJECT_SQL="UPDATE project SET p_name = ?,p_description = ?,p_start_date = ?,p_end_date = ?,budget = ? WHERE p_id = ?;";
    private String DELETE_PROJECT_SQL="DELETE FROM project WHERE p_id = ? ;";
    private String SELECT_ALL_PROJECT_SQL="select * from project";
    ...
    public void addProject(Project project) throws SQLException {
        ...
        statement.setDouble(6, project.setBudget());
